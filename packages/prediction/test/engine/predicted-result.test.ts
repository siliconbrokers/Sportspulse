...
describe('computePredictedResult — DRAW_FLOOR rule (SP-DRAW-13, §18)', () => {
  ...
  it(
    'SP-DRAW-13-01: DRAW_FLOOR activates when p_draw >= floor AND max_other - p_draw <= margin',
    () => {
  ...
  it(
    'SP-DRAW-13-02: DRAW_FLOOR does NOT activate when p_draw is below the floor',
    () => {
  ...
  it(
    'SP-DRAW-13-03: DRAW_FLOOR does NOT activate when max_other - p_draw exceeds DRAW_MARGIN',
    () => {
  ...
  it(
    'SP-DRAW-13-04: TOO_CLOSE takes precedence over DRAW_FLOOR — predicted_result is null',
    () => {
