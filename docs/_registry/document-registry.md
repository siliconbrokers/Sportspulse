...
| artifact_id | title | class | status | version | canonical_path |
|-------------|-------|-------|--------|---------|----------------|
| SPEC-SPORTPULSE-DATA-NORMALIZATION | Data Normalization Specification | spec | active | 1.0.0 | docs/data/spec.sportpulse.data.normalization.md |
| SPEC-SPORTPULSE-DATA-QUALITY | Data Quality Specification | spec | active | 1.0.0 | docs/data/spec.sportpulse.data.quality.md |
| SPEC-SPORTPULSE-DATA-EVENT-LIFECYCLE | Event Lifecycle Specification | spec | active | 1.0.0 | docs/data/spec.sportpulse.data.event-lifecycle.md |
...
| artifact_id | title | class | status | version | canonical_path |
|-------------|-------|-------|--------|---------|----------------|
| SPEC-SPORTPULSE-PRODUCT-FEATURE-EVOLUTION | Feature Evolution Specification | spec | active | 1.0.0 | docs/evolution/spec.sportpulse.product.feature-evolution.md |
| SPEC-SPORTPULSE-PRODUCT-PRODUCT-LOOP | Product Loop Specification | spec | active | 1.0.0 | docs/evolution/spec.sportpulse.product.product-loop.md |
...
> SP-xxxx plans follow the project ticket convention (domain-specific, not renamed).

| artifact_id | title | class | status | canonical_path |
|-------------|-------|-------|--------|----------------|
| PLAN-SPORTPULSE-PREDICTION-PE-ROLLOUT | PE Rollout Plan | plan | active | docs/plans/plan.sportpulse.prediction.pe-rollout.md |
| PLAN-SPORTPULSE-PREDICTION-PE-OBS-EVAL | PE Observation & Evaluation Implementation Plan | plan | active | docs/plans/PE-observation-evaluation-implementation-plan.md |
| PLAN-SPORTPULSE-PORTAL-RADAR | Radar Implementation Plan | plan | active | docs/plans/plan.sportpulse.portal.radar-implementation.md |
| PLAN-SPORTPULSE-PORTAL-COPA-AMERICA | Copa América Implementation Plan | plan | active | docs/plans/SP-COPA-AMERICA.md |
| PLAN-SPORTPULSE-PORTAL-TOURNAMENTS | Tournaments Implementation Plan | plan | active | docs/plans/SP-TOURNAMENTS.md |
| SP-0204 | Proximity Bucket | plan | active | docs/plans/SP-0204-proximity-bucket.md |
| SP-0303 | Legacy Guards | plan | active | docs/plans/SP-0303-legacy-guards.md |
| SP-0501 | Snapshot Identity | plan | active | docs/plans/SP-0501-snapshot-identity.md |
| SP-0502 | Build Pipeline | plan | active | docs/plans/SP-0502-build-pipeline.md |
| SP-0503 | Warning Aggregation | plan | active | docs/plans/SP-0503-warning-aggregation.md |
| SP-0505 | Cache Store | plan | active | docs/plans/SP-0505-cache-store.md |
| SP-0601 | API Dashboard | plan | active | docs/plans/SP-0601-api-dashboard.md |
| SP-0602 | API Team | plan | active | docs/plans/SP-0602-api-team.md |
| SP-0603 | Error Envelope | plan | active | docs/plans/SP-0603-error-envelope.md |
| SP-0701 | Dashboard Page | plan | active | docs/plans/SP-0701-dashboard-page.md |
| SP-0702 | Treemap Render | plan | active | docs/plans/SP-0702-treemap-render.md |
| SP-0703 | Team Detail Panel | plan | active | docs/plans/SP-0703-team-detail-panel.md |
| SP-0704 | Degraded Visuals | plan | active | docs/plans/SP-0704-degraded-visuals.md |
| SP-0801 | Degraded Fixture Harness | plan | active | docs/plans/SP-0801-degraded-fixture-harness.md |
| SP-0802 | All-Zero E2E | plan | active | docs/plans/SP-0802-allzero-e2e.md |
| SP-0901 | Golden Fixtures | plan | active | docs/plans/SP-0901-golden-fixtures.md |
...
> Superseded, duplicated, or export artifacts. Non-authoritative.

| filename | reason | superseded_by |
|----------|--------|---------------|
| `# Match Detail Card Update Spec.md` | Duplicate of SPEC-SPORTPULSE-PORTAL-MATCH-DETAIL-CARD-UPDATE | docs/specs/spec.sportpulse.portal.match-detail-card-update.md |
| `# Motor Predictivo V2.md` | Draft, superseded by PE v1.3 | docs/specs/spec.sportpulse.prediction.engine.md |
| `# SPEC — Back Office...menú.md` | Feature implemented; spec original preserved here | — |
| `# SportPulse — Incremental Rollout Plan Update.md` | Duplicate of PE Rollout Plan | docs/plans/plan.sportpulse.prediction.pe-rollout.md |
| `# SportPulse — Predictive Engine Runtime Observation...md` | Duplicate of PE Observation Plan | docs/plans/PE-observation-evaluation-implementation-plan.md |
| `# Track A Backend Runtime Observation Protocol.md` | Duplicate of Track A Automation Spec | docs/specs/spec.sportpulse.prediction.track-a-observation-automation.md |
| `# Track A Runtime Observation Protocol.md` | Duplicate (same as above) | docs/specs/spec.sportpulse.prediction.track-a-observation-automation.md |
| `MOTOR_PREDICTIVO_V2_SPEC_FINAL_CONGELADA.md` | Superseded by PE v1.3 | docs/specs/spec.sportpulse.prediction.engine.md |
| `match_map_card_frontend_implementation_spec (1).md` | Export artifact (duplicate with `(1)` suffix) | docs/specs/spec.sportpulse.web.match-map-visual-encoding.md |
| `track_a_backend_runtime_observation_template - Hoja 1.csv` | Runtime data export, not a spec | — |
| `spec.sportpulse.prediction.engine-v3-draft-superseded.md` | V3 draft, superseded by PE v1.3 | docs/specs/spec.sportpulse.prediction.engine.md |

---

## Governance Infrastructure (`docs/_governance/`, `docs/_registry/`, `prompts/_registry/`, `scripts/_registry/`)

| artifact_id | title | class | status | version | canonical_path |
|-------------|-------|-------|--------|---------|----------------|
| SPEC-SPORTPULSE-GOVERNANCE-REPOSITORY-GOVERNANCE | Repository Governance Standard | spec | active | 1.0.0 | docs/_governance/repository-governance.md |
| SPEC-SPORTPULSE-GOVERNANCE-NORMALIZATION-PLAYBOOK | Normalization Playbook | spec | active | 1.0.0 | docs/_governance/normalization-playbook.md |
| SPEC-SPORTPULSE-GOVERNANCE-DOCUMENT-REGISTRY | Document Registry | spec | active | 1.0.0 | docs/_registry/document-registry.md |
| SPEC-SPORTPULSE-GOVERNANCE-PROMPT-REGISTRY | Prompt Registry | spec | active | 1.0.0 | prompts/_registry/prompt-registry.md |
| SPEC-SPORTPULSE-GOVERNANCE-SCRIPT-REGISTRY | Script Registry | spec | active | 1.0.0 | scripts/_registry/script-registry.md |
| ARCHIVED-SPORTPULSE-GOVERNANCE-DOCUMENT-REGISTRY-TEMPLATE | Document Registry Template (archived) | spec | superseded | 1.0.0 | docs/archive/legacy-drafts/document-registry-template.md |

---

## Governance Rules for This Registry

1. **New artifact created** → add row to appropriate section
2. **Artifact renamed** → update canonical_path, keep artifact_id stable
3. **Artifact superseded** → change status to `superseded`, add `superseded_by`, move to archive section
4. **Artifact deleted** → only if non-canonical junk — add row to archive with reason
5. **Never** delete a row without replacement
