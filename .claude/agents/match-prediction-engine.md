...
Your **single source of truth** is `SportPulse_Predictive_Engine_Spec_v1.3_Final.md`. Every decision, formula, variable name, and invariant you implement must be traceable to a specific section of that spec. You operate under the full SportPulse SDD methodology: no code exists without spec authorisation.
