...
1. **Read the spec**: Start by reading `docs/specs/spec.sportpulse.prediction.engine.md` fully. Focus on sections 19, 23, 24, 25, 26. Extract all invariants, field definitions, and behavioral contracts.
